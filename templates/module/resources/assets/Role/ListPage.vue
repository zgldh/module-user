  ...
  <div>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>{{$t('module_user.models.role.title')}}</li>
        ...
        <div class="box-body datatable-loading-section">
          <div class="search">
            <el-form :inline="true" :model="searchForm" ref="searchForm">
              <el-form-item :label="$t('module_user.models.role.fields.name')">
                <el-input v-model="searchForm.name" column="name" operator="like"></el-input>
              </el-form-item>
              <el-form-item :label="$t('module_user.models.role.fields.label')">
          ...
          <div class="datatable" style="margin-top:1em;">
            ...
            >
              ...
              <el-table-column
                      prop="name"
                      :label="$t('module_user.models.role.fields.name')"
                      sortable="custom"
                      show-overflow-tooltip>
              </el-table-column>
              <el-table-column
                      prop="label"
                      :label="$t('module_user.models.role.fields.label')"
                      sortable="custom"
                      show-overflow-tooltip>
              </el-table-column>
              <el-table-column
